...
const UUID = process.env.UUID || '7ed3ce56-e724-41df-8a52-9ce6e33e81c0'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || '7ed3ce56-e724-41df-8a52-9ce6e33e81c0';            // 获取节点的订阅路径
